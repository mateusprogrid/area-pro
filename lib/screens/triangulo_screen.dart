...
class _TrianguloScreenState extends State<TrianguloScreen> {
  ...
  void _calcularArea() {
    ...
    final base = double.parse(
      _baseController.text.replaceAll(',', '.'),
    );
            ...
            child: Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const Text(
                    'Faça medições rápidas e estime quanto material será necessário para sua obra ou reforma.',
                    style: TextStyle(
                      fontSize: 15,
                  ...
                  const _SectionTitle(
                    titulo: 'Medidas',
                    subtitulo:
                        'Informe as dimensões da superfície.',
                  ),

                  const SizedBox(height: 18),

                  const _LabelCampo('Base'),
